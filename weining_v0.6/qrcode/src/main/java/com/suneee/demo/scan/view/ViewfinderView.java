...
public final class ViewfinderView extends View {
	...
	public void onDraw(Canvas canvas) {
		...
		// frame.centerX(), (float) (frame.bottom + (float) TEXT_PADDING_TOP *
		// density), paint);
		// canvas.clipRect(0, frame.top, width, frame.bottom);
		// paint.setAlpha(0x40);
		// paint.setColor(Color.rgb(254, 157, 5));
		...
		// R.drawable.line);
		// Bitmap newbm = Bitmap.createScaledBitmap(roundBitmap, frame.right -
		// frame.left - 10, 20, true);
		// canvas.drawBitmap(newbm, frame.left + MIDDLE_LINE_PADDING, slideTop,
		// null);
		//
