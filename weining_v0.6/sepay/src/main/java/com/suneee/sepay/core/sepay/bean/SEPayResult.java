...
public class SEPayResult {
     ...
     */
    public SEPayResult(String result, Integer errCode,
     ...
     */
    public SEPayResult(String result, Integer errCode, String errMsg, String detailInfo, String id) {
        this.result = result;
        this.errCode = errCode;
        this.errMsg = errMsg;
        this.detailInfo = detailInfo;
