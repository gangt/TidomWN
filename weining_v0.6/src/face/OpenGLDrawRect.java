...
public class OpenGLDrawRect {
    ...
    public static ArrayList<FloatBuffer> drawCenterShowRect(boolean isBackCamera, float width, float height, float roi_ratio) {
        ...
        // top_right
        float rectangle_left[] = {_left, _top, 0, _left, _bottom, 0, _left + delta_x, _bottom, 0, _left + delta_x, _top, 0};
        float rectangle_top[] = {_left, _top, 0, _left, _top - delta_y, 0, _right, _top - delta_y, 0, _right, _top, 0};
        float rectangle_right[] = {_right - delta_x, _top, 0, _right - delta_x, _bottom, 0, _right, _bottom, 0, _right, _top, 0};
        float rectangle_bottom[] = {_left, _bottom + delta_y, 0, _left, _bottom, 0, _right, _bottom, 0, _right, _bottom + delta_y, 0};
