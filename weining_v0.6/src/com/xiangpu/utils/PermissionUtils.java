...
public class PermissionUtils {
     ...
     * @return 是否已经获取权限，没有自动申请
     */
    public static boolean getPhoneStatePermissions(@NonNull Context context, int requestCode) {
        if (context instanceof Activity) {
            return requestPerssions((Activity) context, requestCode, Manifest.permission.READ_PHONE_STATE);
        } else {
