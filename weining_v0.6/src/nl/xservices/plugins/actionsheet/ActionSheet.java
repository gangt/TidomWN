...
public class ActionSheet extends CordovaPlugin {
  ...
  public boolean execute(String action, JSONArray args, CallbackContext callbackContext) throws JSONException {
    ...
    if ("show".equals(action)) {
      ...
      JSONObject message = options.optJSONObject("message");
      ...
      this.show(title,message , buttons, addCancelButtonWithLabel,
...
//        }
        ...
        builder.setItems(buttons, new OnClickListener() {
          ...
          public void onClick(DialogInterface dialog, int which) {
            ...
            if (message != null && "复制".equals(buttons[which])) {
              String msg = message.optString("msg");
              ClipboardManager clipboard  = (ClipboardManager) cordova.getActivity().getSystemService(cordova.getActivity().CLIPBOARD_SERVICE);
