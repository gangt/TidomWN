...
public class ConstantApp {
    ...
    public static final int PERMISSION_REQ_ID_WAKE_LOCK = BASE_VALUE_PERMISSION + 4;
    ...
    public static final String ACTION_KEY_VIDEO_TYPE = "video_type";
    public static final String ACTION_KEY_VIDEO_NAME = "name";
    public static final String ACTION_KEY_VIDEO_HEAD = "avatar";
    public static final String ACTION_KEY_VIDEO_USERID = "userId";
