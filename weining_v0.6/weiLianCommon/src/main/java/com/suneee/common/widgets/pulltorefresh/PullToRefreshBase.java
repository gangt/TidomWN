 ...
 *******************************************************************************/
package com.suneee.common.widgets.pulltorefresh;

import com.suneee.common.R;
import com.suneee.common.widgets.pulltorefresh.internal.FlipLoadingLayout;
import com.suneee.common.widgets.pulltorefresh.internal.LoadingLayout;
import com.suneee.common.widgets.pulltorefresh.internal.RotateLoadingLayout;
import com.suneee.common.widgets.pulltorefresh.internal.Utils;
import com.suneee.common.widgets.pulltorefresh.internal.ViewCompat;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
    ...
    public void doPullRefreshing(final boolean smoothScroll, final long delayMillis) {
        postDelayed(new Runnable() {
            @Override
            public void run() {
                //int newScrollValue = -getHeaderSize();
                //int duration = smoothScroll ? SMOOTH_SCROLL_DURATION_MS : 0;
