 ...
 * 
 * copied from 
 * https://raw.github.com/android/platform_frameworks_base/donut-release/core/java/android/widget/FastScroller.java
 * bysong@tudou.com
 */
/**
...
class FastScroller {
	...
	private void useThumbDrawable(Context context, Drawable drawable) {
		...
		mThumbW = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 64, context.getResources().getDisplayMetrics());
		mThumbH = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 52, context.getResources().getDisplayMetrics());
		mChangedBounds = true;
	}
	...
	private void getSectionsFromIndexer() {
		...
		// ((ExpandableListConnector)adapter).getAdapter();
